...
var proto = TrackEventTarget.prototype;

module.exports = TrackEventTarget;

function TrackEventTarget(target, event, valueGetter) {
  if (!(this instanceof TrackEventTarget)) {
    return new TrackEventTarget(target, event, valueGetter);
  }
  this.event = event;
